<div style="padding-left: -40px; margin-top: 20px;">
                        ...
                        <div style="transform: translateY(-500px); float: right; width: 500px; height: 350px; margin-right: 70px;">
                            <div style="margin-left: 90px; margin-top: 5px;">
                                <label for="" style="font-size: 18px; font-weight: 700; margin-top: 12px; margin-bottom: 10px;">DAILY ACTIVITY REPORT COMPACT</label>
                                <p>This report is the Orginal DAR Report brought back by popular demand!
                                    <div>
                                    <label style="color: red; font-weight: 500;font-size: medium; margin-left: 180px;">NOTE: </label>
                                    <p>If you need to run this dar for all Properties, you must
                                        select a property group conataining all the properties you want to include.
                                        issues, you should use the issue History report. <br> Available in PDF Only
                                    </p>
                                    </div>
                                </p>
                            </div>
