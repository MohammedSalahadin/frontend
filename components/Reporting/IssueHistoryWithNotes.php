<div style="padding-left: -40px; margin-top: 20px;">
                        ...
                        <div style="margin-left: -18px;">
                            ...
                            <div style="padding-left: 35px; margin-top: 10px;">
                                ...
                                <button type="button" id="" class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="background-color: #204e89; color: white; font-weight: 500; font-size: 15px; width: 100px; height: 32px; margin-top: -4px; ">Choose</button>

                                <div class="modal" id="myModal" style="transform: translateY(100px);">
