<nav class="navbar navbar-expand-lg navbar-light d-flex justify-content-between">
    ...
    <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarSupportedContent">
        <div class="">
            <a class="navbar-brand" href="../issues/monitor.php">
                <img src="../../../assets/images/logo.png" alt="" class="nav-logo" width="50" hight="50">
            </a>
            ...
            <ul class="navbar-nav mr-auto ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="../../reporting/report_legacy">All Reports (Legacy)</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="">
            <div class="row">ID: 33</div>
            <div class="row">User: Mohammed Hazim</div>
        </div>
    </div>
</nav>
