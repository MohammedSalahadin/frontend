<div class="modal fade" id="editAddress" tabindex="-1" aria-labelledby="editShippingAdress" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editShippingAdress">Edit Address</h5>
            ...
            <form name="" action="" method="post">
                    ...
                    <div class="form-group row px-4 my-2">
                        <label for="building_number" class="col-md-4 col-form-label text-md-right">Building Number</label>
                        <div class="col-md-8 px-0">
                            <input type="text" id="building_number" class="form-control rounded-0 bg-light" name="building_number">
                        </div>
                    </div>
