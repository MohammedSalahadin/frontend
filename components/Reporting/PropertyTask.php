...
<div style="margin-left: 110px;">
                        <div style="margin-left: -18px;">
                            ...
                            <div style="margin-top: 20px; margin-left: 40px;">
                                ...
                                <input type="radio" id="r1" name="" value="CSV" style="margin-left: 20px; margin-bottom: 200px; accent-color: gray;">
                            ...
                            <div style="transform: translateY(-430px); float: right; width: 500px; height: 350px; margin-right: 70px;">
                                <div style="margin-left: 90px; margin-top: 5px;">
                                    <label for="" style="font-size: 18px; font-weight: 700;">Property Set Tasks</label>
                                    <p>This report shows ALL the set tasks for each property in the system. This report is useful for identifying what 
                                        task are currently set in the system and which property 
                                        it is assigned to: The following report includes:
                                        <div>
                                            <ul>
                                                ...
                                                <li>Issue Type</li>
                                                <li>Name of Task</li>
                                                <li>Next scheduled Issue Data</li>
