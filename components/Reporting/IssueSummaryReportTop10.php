                                ...
                                <option value=""></option>
                                    ...
                                    <div style="transform: translateY(-500px); float: right; width: 500px; height: 350px; margin-right: 70px;">
                                        <div style="margin-left: 90px; margin-top: 5px;">
                                            <label for="" style="font-size: 18px; font-weight: 700; margin-top: 12px; margin-bottom: 10px;">Issue Summary Top 10</label>
                                            <p>This report shows the Top 10 properties with the most 
                                                reported Security, Maintenance and Parking Issues. This 
                                                report also displays the Top 10 most report Security, Maintenance and Parking issue types. A graph is also 
                                                depicted to show indicate the total amount of issues 
                                                reported within the time frame selected. Available in PDF ONLY
                                            </p>
                                        </div>
                                    </div>
