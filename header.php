...
<head>
  ...
  <link rel="stylesheet" href="<?=$global->SITE_URL?>/assets/styles/styles.css?v=<?=time()?>">
...
<link rel="shortcut icon" href="http://192.168.64.2/Frontend/assets/images/icon.png?v=<?=time()?>" />
<link rel="icon" type="image/vnd.microsoft.icon" href="http://192.168.64.2/Frontend/assets/images/icon.png"?v=<?=time()?>">
<link rel="icon" type="image/x-icon" href="http://192.168.64.2/Frontend/assets/images/icon.png?v=<?=time()?>">
<link rel="icon" href="http://192.168.64.2/Frontend/assets/images/icon.png?v=<?=time()?>" />
